 ...
 *
 * Converted to FGL by Sam Lantinga on 10/19/98
 *
...
#define WIDTH	fgl::GetXRes()
#define HEIGHT	fgl::GetYRes()
...
int main(int argc, char *argv[])
{
  ...
  /* Create a RGB color display */
  fgl::FGApp myapp(2, argc, argv, 0, fgl::APP_ALL);
  fgl::GLSurface *ctx;
  ctx = new fgl::GLSurface(fgl::FGApp::GetRootWindow(), 0,0,0);
  ...
  /* Set the shape of the render area and go! */
